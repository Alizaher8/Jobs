        ...
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-navlink  href="/jobs" :active="request()->is('jobs')" >Job</x-navlink>
              </div>
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
                ...
                <x-navlink href="/register/create" :active="request()->is('register/create')">Register</x-navlink>
                @endguest
            ...
            @auth
            <div class="ml-4 flex items-center md:ml-6">
                <x-navlink href="/logout" :active="request()->is('logout')">logout</x-navlink>
            </div>
            @endauth
          </div>
